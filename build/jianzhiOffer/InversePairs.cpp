 ...
 * @LastTime: 2020-03-07 21:13:18
 * @LastAuthor: Zhang Zhaoru
 * @FilePath: \vscode_git\build\jianzhiOffer\InversePairs.cpp
 * @Description: 
 */
#include <iostream>
#include <vector>
...
long long InversePairsCore(vector<int> &data, vector<int> &copy, int start,
                           int end);
...
int InversePairs(vector<int> data) {
    ...
    vector<int> copy;
    for (int i = 0; i < length; i++) copy.push_back(data[i]);
